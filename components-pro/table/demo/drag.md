...
// downloadExcel = (dataSet, fileName) => {
//   const data = (() => { 
//       let dataR = []
//       for(let i = 0; i < 100; i++){
//         dataR = [...dataR,...dataSet.toData()]
//       }
//       return dataR
//   })(100)
//   const headers = toJS(dataSet.props.fields)
//   var option={};
//   let dataTable = [];
//   if (data) {
//     for (let i in data) {
...
//           obj[headers[j].label] = data[i][headers[j].name]
//         }
//         dataTable.push(obj);
//       }
//     }
...
//       sheetHeaderT.push(headers[d].label)
//     }
//     return sheetHeaderT
//   }
...
class App extends React.Component {
  ...
  renderButton = (<Button icon="graphic_eq" key="fuck"  onClick={() => {exportExcel(this.userDs,"人员名单")}}>导出</Button>);


  render() {
    const buttons = [this.renderButton, 'save', 'delete', 'reset'];
    return (
